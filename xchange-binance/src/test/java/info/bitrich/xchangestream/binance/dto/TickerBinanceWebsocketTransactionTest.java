...
public class TickerBinanceWebsocketTransactionTest {
    ...
    public void test_deserialization_of_transaction_message() throws IOException {
        ...
        assertThat(ticker.getPriceChange()).isEqualByComparingTo(-0.00271700);
        assertThat(ticker.getPriceChangePercent()).isEqualByComparingTo(-2.875);
        assertThat(ticker.getWeightedAvgPrice()).isEqualByComparingTo(0.09158373);

        assertThat(ticker.getPrevClosePrice()).isEqualByComparingTo(0.09448900);
        assertThat(ticker.getLastPrice()).isEqualByComparingTo(0.09177200);
        assertThat(ticker.getLastQty()).isEqualByComparingTo(0.06100000);
        assertThat(ticker.getBidPrice()).isEqualByComparingTo(0.09155300);
        assertThat(ticker.getBidQty()).isEqualByComparingTo(1.75300000);
        assertThat(ticker.getAskPrice()).isEqualByComparingTo(0.09177200);
        assertThat(ticker.getAskQty()).isEqualByComparingTo(1.83900000);
        assertThat(ticker.getOpenPrice()).isEqualByComparingTo(0.09448900);
        assertThat(ticker.getHighPrice()).isEqualByComparingTo(0.09575800);
        assertThat(ticker.getLowPrice()).isEqualByComparingTo(0.08100000);
        assertThat(ticker.getVolume()).isEqualByComparingTo(287542.79200000);
        assertThat(ticker.getQuoteVolume()).isEqualByComparingTo(26334.24227973);
